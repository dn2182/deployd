...
readonly AUTH_DIR="/var/lib/deployd-auth"
readonly HTPASSWD_FILE="${AUTH_DIR}/htpasswd"
readonly LEGACY_HTPASSWD_FILE="/etc/nginx/deployd.htpasswd"
readonly PASSWORD_HELPER="/usr/local/libexec/deployd/change-password"
readonly PASSWORD_SUDOERS="/etc/sudoers.d/deployd-password"
